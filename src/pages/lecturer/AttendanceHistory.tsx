...
import { getUserById, getCourseUnitsForLecturer, getClassInstancesForCourse, getAttendanceRecordsForClassInstance } from '../../data/mockData';
...
export function AttendanceHistory() {
  ...
  const dayItemsByDate = useMemo(() => {
    ...
    for (const course of courses) {
      ...
      for (const instance of instances) {
        ...
        const records = getAttendanceRecordsForClassInstance(instance.id).filter((r) => r.userId === lecturer.id);
  ...
  return (
    <div className="px-4 py-4">
      ...
      <p className="mb-4 -mt-3 text-xs text-zinc-500 dark:text-zinc-400">Your own recorded presence across every class you teach.</p>
